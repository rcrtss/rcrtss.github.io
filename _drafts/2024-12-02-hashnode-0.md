...
These charts were designed to compare between different search methods and heuristic functions, and analyzing how the solution to each problem behaves when adding more actions to the problem.
